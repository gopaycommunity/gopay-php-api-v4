...
curl -fsSL https://payments-api.beta.gopay.com/spec/en/payments.yaml -o spec/payments.yaml
...
SPEC_URL="https://payments-api.beta.gopay.com/spec/en/payments.yaml"
