...
/**
 * BankAccountLocalDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class BankAccountLocalDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bank-Account-Local-Details';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('variableSymbol', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets prefix
     *
     * @param string $prefix Account number prefix (may be all zeros)
     *
     * @return self
     */
     ...
     * Sets accountNumber
     *
     * @param string $accountNumber The local bank account number
     *
     * @return self
     */
     ...
     * Sets bankCode
     *
     * @param string $bankCode Numeric bank code identifying the bank
     *
     * @return self
     */
     ...
     * Sets variableSymbol
     *
     * @param string $variableSymbol Variable symbol used to match the payment to an order
     *
     * @return self
     */
    public function setVariableSymbol($variableSymbol)
    {
        if (is_null($variableSymbol)) {
            throw new \InvalidArgumentException('non-nullable variableSymbol cannot be null');
        }
