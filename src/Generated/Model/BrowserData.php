...
class BrowserData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets userAgent
     *
     * @param string $userAgent User-Agent string of the customer's browser, as returned by the browser data endpoint. Take it from the same source as `ip` — a pair that disagrees fails 3-D Secure authentication
     *
     * @return self
     */
     ...
     * Sets acceptHeader
     *
     * @param string $acceptHeader JSON-encoded Accept headers from the customer's browser, as returned by the browser data endpoint. Take it from the same source as `ip`
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string $ip IP address of the customer's browser, as returned by the browser data endpoint. A merchant server charging on the customer's behalf must forward the value collected in the browser, never its own address
     *
     * @return self
     */
    public function setIp($ip)
    {
        ...
        if ((mb_strlen($ip) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling BrowserData., must be smaller than or equal to 45.');
        }
